...
* [Whisper Code](https://github.com/openai/whisper) ⭐ 109,549 | 🐛 152 | 🌐 Python | 📅 2026-08-31
...
* [Whisper Playground](https://whisperui.monsterapi.ai/)
  * [Source](https://github.com/saharmor/whisper-playground) ⭐ 838 | 🐛 16 | 🌐 Python | 📅 2025-09-12
* [Web Whisper - 🎶 Convert any audio to text 📝](https://whisper.r3d.red)
  * [Source](https://codeberg.org/pluja/web-whisper)

## Model Variants

* [whisper.cpp - Port of OpenAI's Whisper model in C/C++](https://github.com/ggerganov/whisper.cpp) ⭐ 53,902 | 🐛 343 | 🌐 C++ | 📅 2026-09-24
  * [pywhispercpp -  Python bindings for whisper.cpp ](https://github.com/abdeladim-s/pywhispercpp)
* [Faster Whisper - reimplementation using CTranslate2 up to 4 times faster](https://github.com/guillaumekln/faster-whisper) ⭐ 25,547 | 🐛 323 | 🌐 Python | 📅 2025-11-19
* [Whisper JAX - optimised JAX code, largely built on the hugs Hugging Face Transformers Whisper implementation, over 70x faster](https://github.com/sanchit-gandhi/whisper-jax/) ⭐ 4,679 | 🐛 138 | 🌐 Jupyter Notebook | 📅 2024-04-03
* [whisper-timestamped - Whisper  with word-level timestamps and confidence ](https://github.com/linto-ai/whisper-timestamped) ⭐ 2,847 | 🐛 48 | 🌐 Python | 📅 2026-08-17
...
* [whisper-export - openvino version of openai/whisper](https://github.com/axinc-ai/whisper-export) ⭐ 16 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-06-19
  * [onnx-export](https://github.com/axinc-ai/whisper-export/tree/onnx-export) ⭐ 16 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-06-19
...
* [WhisperX: Automatic Speech Recognition with Accurate Word-level Timestamps.](https://github.com/m-bain/whisperX) ⭐ 24,222 | 🐛 226 | 🌐 Python | 📅 2026-08-30
* [buzz - Buzz transcribes audio from your computer's microphones to text using OpenAI's Whisper](https://github.com/chidiwilliams/buzz) ⭐ 21,654 | 🐛 19 | 🌐 Python | 📅 2026-09-23
* [AutoCut - generate video subtitles and edit the video by selecting subtitle clips](https://github.com/mli/autocut) ⭐ 7,811 | 🐛 24 | 🌐 Python | 📅 2024-10-05
...
* [Whisper as a Service (GUI and API for OpenAI Whisper)](https://github.com/schibsted/WAAS) ⭐ 2,074 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-06
* [🎞️ Subtitles generation tool (Web-UI + CLI + Python package)](https://github.com/abdeladim-s/subsai) ⭐ 1,677 | 🐛 77 | 🌐 Python | 📅 2026-04-20
* [Automatic YouTube subtitle generation](https://github.com/m1guelpf/yt-whisper) ⭐ 1,446 | 🐛 24 | 🌐 Python | 📅 2024-01-16
* [Whisper Playground - Build real time speech2text web apps using OpenAI's Whisper](https://github.com/saharmor/whisper-playground) ⭐ 838 | 🐛 16 | 🌐 Python | 📅 2025-09-12
...
* [WhisperSubTranslate - Free, open source desktop app that turns any video into translated subtitles (whisper.cpp + local LLM or DeepL/OpenAI/Gemini)](https://github.com/Blue-B/WhisperSubTranslate) ⭐ 745 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-03
...
* [WhisperSubs - Jellyfin plugin for local AI-powered subtitle generation using whisper.cpp](https://github.com/GeiserX/whisper-subs) ⭐ 102 | 🐛 3 | 🌐 C# | 📅 2026-09-24
