# awesome-openai-whisper with stars
...
* [Whisper Code](https://github.com/openai/whisper) ⭐ 107,193 | 🐛 135 | 🌐 Python | 📅 2026-07-28
...
* [Whisper Playground](https://whisperui.monsterapi.ai/)
  * [Source](https://github.com/saharmor/whisper-playground) ⭐ 834 | 🐛 16 | 🌐 Python | 📅 2025-09-12
* [Web Whisper - 🎶 Convert any audio to text 📝](https://whisper.r3d.red)
  * [Source](https://codeberg.org/pluja/web-whisper)

## Model Variants

* [whisper.cpp - Port of OpenAI's Whisper model in C/C++](https://github.com/ggerganov/whisper.cpp) ⭐ 52,859 | 🐛 1,239 | 🌐 C++ | 📅 2026-08-07
  * [pywhispercpp -  Python bindings for whisper.cpp ](https://github.com/abdeladim-s/pywhispercpp)
* [Faster Whisper - reimplementation using CTranslate2 up to 4 times faster](https://github.com/guillaumekln/faster-whisper) ⭐ 24,883 | 🐛 314 | 🌐 Python | 📅 2025-11-19
* [Whisper JAX - optimised JAX code, largely built on the hugs Hugging Face Transformers Whisper implementation, over 70x faster](https://github.com/sanchit-gandhi/whisper-jax/) ⭐ 4,682 | 🐛 140 | 🌐 Jupyter Notebook | 📅 2024-04-03
* [whisper-timestamped - Whisper  with word-level timestamps and confidence ](https://github.com/linto-ai/whisper-timestamped) ⭐ 2,837 | 🐛 49 | 🌐 Python | 📅 2025-09-09
...
* [whisper-export - openvino version of openai/whisper](https://github.com/axinc-ai/whisper-export) ⭐ 15 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-06-19
  * [onnx-export](https://github.com/axinc-ai/whisper-export/tree/onnx-export) ⭐ 15 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2026-06-19
* [whisper\_onnx](https://github.com/Fhrozen/whisper_onnx)
* [Whisper models on Hugging Face](https://huggingface.co/models?other=whisper)

## Applications

* [WhisperX: Automatic Speech Recognition with Accurate Word-level Timestamps.](https://github.com/m-bain/whisperX) ⭐ 23,554 | 🐛 211 | 🌐 Python | 📅 2026-07-13
* [buzz - Buzz transcribes audio from your computer's microphones to text using OpenAI's Whisper](https://github.com/chidiwilliams/buzz) ⭐ 20,932 | 🐛 22 | 🌐 Python | 📅 2026-08-10
* [AutoCut - generate video subtitles and edit the video by selecting subtitle clips](https://github.com/mli/autocut) ⭐ 7,784 | 🐛 23 | 🌐 Python | 📅 2024-10-05
  * [AutoCut Client](https://github.com/zcf0508/autocut-client) ⭐ 339 | 🐛 21 | 🌐 TypeScript | 📅 2024-10-23
* [stable-ts - Stabilizing Timestamps for Whisper](https://github.com/jianfch/stable-ts) ⚠️ Archived
* [Whisper as a Service (GUI and API for OpenAI Whisper)](https://github.com/schibsted/WAAS) ⭐ 2,074 | 🐛 34 | 🌐 JavaScript | 📅 2026-07-02
* [🎞️ Subtitles generation tool (Web-UI + CLI + Python package)](https://github.com/abdeladim-s/subsai) ⭐ 1,680 | 🐛 77 | 🌐 Python | 📅 2026-04-20
...
* [React hook for OpenAI Whisper](https://github.com/chengsokdara/use-whisper) ⭐ 785 | 🐛 36 | 🌐 TypeScript | 📅 2024-04-30
* [whispering - Streaming transcriber with whisper](https://github.com/shirayu/whispering) ⚠️ Archived
* [WhisperSubTranslate - Free, open source desktop app that turns any video into translated subtitles (whisper.cpp + local LLM or DeepL/OpenAI/Gemini)](https://github.com/Blue-B/WhisperSubTranslate) ⭐ 574 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-09
* [Speaker Identification - Pyannote plays and Whisper rhymes](https://github.com/Majdoddin/nlp) ⭐ 490 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2025-09-10
* [whisper-youtube - 🔉 Youtube Videos Transcription with OpenAI's Whisper](https://github.com/ArthurFDLR/whisper-youtube) ⭐ 421 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2024-04-23
* [💬 ASR FastAPI](https://github.com/Wordcab/wordcab-transcribe) ⭐ 219 | 🐛 5 | 🌐 Python | 📅 2024-10-30
* [WhisperSubs - Jellyfin plugin for local AI-powered subtitle generation using whisper.cpp](https://github.com/GeiserX/whisper-subs) ⭐ 89 | 🐛 2 | 🌐 C# | 📅 2026-08-10
